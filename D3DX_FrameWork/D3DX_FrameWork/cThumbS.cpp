...
void cThumbS::Init()
{
	...
	D3DXMatrixTranslation(&matT, 1.6f, 3.3f, 0.0f);
...
void cThumbS::ThumbGMotion()
{
	...
	D3DXMatrixTranslation(&matMoveT, 0.0f, -3.0f, 0.0f);
	D3DXMatrixTranslation(&matOriginT, 0.0f, 3.0f, 0.0f);
	D3DXMatrixRotationX(&matR, angleY);
}

bool cThumbS::Recover()
{
	//D3DXMatrixIdentity(&matR);
	//D3DXMatrixIdentity(&matMoveT);
