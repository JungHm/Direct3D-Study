// D3DX_FrameWork.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//

#include "stdafx.h"
#include "D3DX_FrameWork.h"
#include "cMainGame.h"
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_D3DX_FRAMEWORK, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_D3DX_FRAMEWORK));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_D3DX_FRAMEWORK);
